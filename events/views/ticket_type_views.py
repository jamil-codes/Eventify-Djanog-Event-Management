...
def add_ticket_type(request, event_pk):
    ...
    if request.method == "POST":
        ...
        form = TicketTypeForm()
    return render(request, 'events/ticket_type_templates/add_ticket_type.html', {
        'form': form,
        'event': event
    })
...
def edit_ticket_type(request, event_pk, ticket_type_pk):
    ...
    return render(request, 'events/ticket_type_templates/edit_ticket_type.html', {
        'form': form,
        'event': event,
...
def delete_ticket_type(request, event_pk, ticket_type_pk):
    ...
    return render(request, 'events/ticket_type_templates/delete_ticket_type.html', {
        'event': event,
        'ticket_type': ticket_type,
    })
